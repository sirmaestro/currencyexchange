...
$.ajax({
     ...
     success:function(json) {
         ...
         fx.rates = json.rates
         window.FIXER_RESPONSE = json
     },
     error:function(){
         alert("Sorry we can't get the rate right now, please try again later");
         fx.rates = window.FIXER_RESPONSE.rates
     }      
});

// $(".main-content").on('click', function() {
// 	console.log(window.FIXER_RESPONSE.rates.USD)
// })
